      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-2 min-h-0 lg:min-h-[70vh] items-start lg:items-center">
        ...
        <div className="relative z-10 flex flex-col justify-center px-6 sm:px-10 lg:pl-16 lg:pr-12 py-10 sm:py-12 lg:py-24 order-2 lg:order-1">
          ...
          >
            <a
              href="tel:9542134572"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gray-900 text-white font-bold rounded-none text-lg hover:bg-black shadow-lg transition-all"
            >
            ...
            <a
              href="#services"
              className="inline-flex items-center justify-center px-8 py-4 bg-white border-2 border-primary-green text-primary-green font-semibold rounded-none text-lg hover:bg-primary-green/10 transition-all"
            >
              Our Services
            </a>
          </motion.div>
